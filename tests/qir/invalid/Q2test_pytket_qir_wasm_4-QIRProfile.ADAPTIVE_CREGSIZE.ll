...
entry:
  ...
  %11 = call i1 @__quantum__qis__read_result__body(ptr inttoptr (i64 1 to ptr))
  ...
  %19 = call i1 @__quantum__qis__read_result__body(ptr inttoptr (i64 2 to ptr))
  ...
  call void @__quantum__rt__int_record_output(i64 %26, ptr @0)
  call void @__quantum__rt__int_record_output(i64 0, ptr @1)
  call void @__quantum__rt__int_record_output(i64 %29, ptr @2)
  ret void
}
