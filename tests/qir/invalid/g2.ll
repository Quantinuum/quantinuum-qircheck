...
NodeBlock10915:                                   ; preds = %cond_exit_4551
  ...
  %.mux = select i1 %Pivot10918, %Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 6 to %Qubit*)
  %15 = tail call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 4 to %Result*))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull %.mux)
