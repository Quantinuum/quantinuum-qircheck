...
NodeBlock10915:                                   ; preds = %alloca_block
...
NodeBlock10905:                                   ; preds = %alloca_block
  %qu = phi %Qubit* [ inttoptr (i64 4 to %Qubit*), %alloca_block ]
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull %qu)
  %Pivot10906 = icmp slt i64 %14, 5
  br i1 %Pivot10906, label %41, label %41

41:        ; preds = %NodeBlock10915, NodeBlock10905
  ret void
}
