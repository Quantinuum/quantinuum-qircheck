...
entry:
  ...
  call void @__quantum__qis__barrier2__body(ptr null, ptr inttoptr (i64 1 to ptr))
  call void @__quantum__qis__barrier1__body(ptr null)
  call void @__quantum__qis__h__body(ptr inttoptr (i64 1 to ptr))
  call void @__quantum__qis__h__body(ptr inttoptr (i64 1 to ptr))
  call void @__quantum__qis__barrier4__body(ptr null, ptr inttoptr (i64 1 to ptr), ptr inttoptr (i64 3 to ptr), ptr inttoptr (i64 4 to ptr))
...
declare void @__quantum__qis__barrier2__body(ptr, ptr)

declare void @__quantum__qis__barrier1__body(ptr)

declare void @__quantum__qis__barrier4__body(ptr, ptr, ptr, ptr)
