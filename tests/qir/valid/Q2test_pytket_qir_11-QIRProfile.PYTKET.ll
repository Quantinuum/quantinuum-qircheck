...
entry:
  ...
  %1 = call ptr @create_creg(i64 4)
  %2 = call i1 @get_creg_bit(ptr %0, i64 0)
  call void @set_creg_bit(ptr %1, i64 0, i1 %2)
  %3 = call i1 @get_creg_bit(ptr %0, i64 1)
  call void @set_creg_bit(ptr %1, i64 1, i1 %3)
  ...
  call void @__quantum__rt__int_record_output(i64 %5, ptr @1)
  ret void
}
