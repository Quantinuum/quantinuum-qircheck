...
condb0:                                           ; preds = %entry
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 0)
  br label %contb0
...
condb1:                                           ; preds = %contb0
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 1)
  br label %contb1
...
condb2:                                           ; preds = %contb1
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 2)
  br label %contb2

contb2:                                           ; preds = %condb2, %contb1
  %6 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %6, label %condb3, label %contb3

condb3:                                           ; preds = %contb2
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 3)
  br label %contb3
...
condb4:                                           ; preds = %contb3
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 4)
  br label %contb4

contb4:                                           ; preds = %condb4, %contb3
  %8 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %8, label %condb5, label %contb5

condb5:                                           ; preds = %contb4
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 5)
  br label %contb5

contb5:                                           ; preds = %condb5, %contb4
  %9 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %9, label %condb6, label %contb6

condb6:                                           ; preds = %contb5
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 6)
  br label %contb6

contb6:                                           ; preds = %condb6, %contb5
  %10 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %10, label %condb7, label %contb7

condb7:                                           ; preds = %contb6
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 7)
  br label %contb7

contb7:                                           ; preds = %condb7, %contb6
  %11 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %11, label %condb8, label %contb8

condb8:                                           ; preds = %contb7
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 8)
  br label %contb8

contb8:                                           ; preds = %condb8, %contb7
  %12 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %12, label %condb9, label %contb9

condb9:                                           ; preds = %contb8
  call void @mz_to_creg_bit(ptr null, ptr %1, i64 9)
  br label %contb9
...
contb10:                                          ; preds = %condb10, %contb9
  %14 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %14, label %condb11, label %contb11

condb11:                                          ; preds = %contb10
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 0)
  br label %contb11

contb11:                                          ; preds = %condb11, %contb10
  %15 = call i1 @get_creg_bit(ptr %0, i64 0)
...
condb25:                                          ; preds = %contb24
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 13)
  br label %contb25

contb25:                                          ; preds = %condb25, %contb24
  %29 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %29, label %condb26, label %contb26

condb26:                                          ; preds = %contb25
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 14)
  br label %contb26

contb26:                                          ; preds = %condb26, %contb25
  %30 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %30, label %condb27, label %contb27

condb27:                                          ; preds = %contb26
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 15)
  br label %contb27

contb27:                                          ; preds = %condb27, %contb26
  %31 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %31, label %condb28, label %contb28

condb28:                                          ; preds = %contb27
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 16)
  br label %contb28

contb28:                                          ; preds = %condb28, %contb27
  %32 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %32, label %condb29, label %contb29

condb29:                                          ; preds = %contb28
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 17)
  br label %contb29

contb29:                                          ; preds = %condb29, %contb28
  %33 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %33, label %condb30, label %contb30

condb30:                                          ; preds = %contb29
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 18)
  br label %contb30

contb30:                                          ; preds = %condb30, %contb29
  %34 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %34, label %condb31, label %contb31

condb31:                                          ; preds = %contb30
  call void @mz_to_creg_bit(ptr null, ptr %2, i64 19)
  br label %contb31

contb31:                                          ; preds = %condb31, %contb30
  %35 = call i1 @get_creg_bit(ptr %0, i64 0)
  br i1 %35, label %condb32, label %contb32

condb32:                                          ; preds = %contb31
  %36 = call i64 @get_int_from_creg(ptr %0)
  %37 = call i64 @get_int_from_creg(ptr %1)
  %38 = add i64 %36, %37
  call void @set_creg_to_int(ptr %2, i64 %38)
  br label %contb32

contb32:                                          ; preds = %condb32, %contb31
  %39 = call i64 @get_int_from_creg(ptr %0)
  call void @__quantum__rt__int_record_output(i64 %39, ptr @0)
  %40 = call i64 @get_int_from_creg(ptr %1)
  call void @__quantum__rt__int_record_output(i64 %40, ptr @1)
  %41 = call i64 @get_int_from_creg(ptr %2)
  call void @__quantum__rt__int_record_output(i64 %41, ptr @2)
  ret void
}
