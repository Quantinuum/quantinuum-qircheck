...
contb0:                                           ; preds = %condb0, %entry
  ...
  %1 = call i1 @__quantum__qis__read_result__body(ptr inttoptr (i64 2 to ptr))
  %2 = zext i1 %1 to i64
  %3 = mul i64 %2, 4
  %4 = or i64 %3, %0
  %5 = sub i64 1, %2
  ...
  %17 = call i1 @__quantum__qis__read_result__body(ptr null)
  ...
  call void @__quantum__rt__int_record_output(i64 %24, ptr @3)
  ret void
}
