...
entry:
  ...
  %5 = call i64 @get_int_from_creg(ptr %2)
  ...
  call void @__quantum__rt__int_record_output(i64 %8, ptr @1)
  %9 = call i64 @get_int_from_creg(ptr %2)
  call void @__quantum__rt__int_record_output(i64 %9, ptr @2)
  ret void
}
