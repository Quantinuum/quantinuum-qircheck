...
entry:
  ...
  call void @mz_to_creg_bit(ptr inttoptr (i64 3 to ptr), ptr %0, i64 3)
  call void @mz_to_creg_bit(ptr inttoptr (i64 4 to ptr), ptr %0, i64 4)
  call void @mz_to_creg_bit(ptr inttoptr (i64 5 to ptr), ptr %0, i64 5)
  call void @mz_to_creg_bit(ptr inttoptr (i64 6 to ptr), ptr %0, i64 6)
  call void @mz_to_creg_bit(ptr inttoptr (i64 7 to ptr), ptr %0, i64 7)
  call void @mz_to_creg_bit(ptr inttoptr (i64 8 to ptr), ptr %0, i64 8)
  call void @mz_to_creg_bit(ptr inttoptr (i64 9 to ptr), ptr %0, i64 9)
