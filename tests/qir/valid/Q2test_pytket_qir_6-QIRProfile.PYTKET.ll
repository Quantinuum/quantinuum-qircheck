...
entry:
  ...
  %7 = call i1 @get_creg_bit(ptr %2, i64 4)
...
contb0:                                           ; preds = %condb0, %entry
  ...
  call void @__quantum__rt__int_record_output(i64 %8, ptr @0)
  %9 = call i64 @get_int_from_creg(ptr %1)
  call void @__quantum__rt__int_record_output(i64 %9, ptr @1)
  %10 = call i64 @get_int_from_creg(ptr %2)
  call void @__quantum__rt__int_record_output(i64 %10, ptr @2)
  %11 = call i64 @get_int_from_creg(ptr %3)
  call void @__quantum__rt__int_record_output(i64 %11, ptr @3)
  ret void
}
