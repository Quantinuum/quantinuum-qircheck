...
contb0:                                           ; preds = %condb0, %entry
  ...
  %43 = icmp eq i64 2, %42
  call void @set_creg_bit(ptr %4, i64 5, i1 %43)
  %44 = call i1 @get_creg_bit(ptr %4, i64 1)
...
contb1:                                           ; preds = %condb1, %contb0
  %45 = call i1 @get_creg_bit(ptr %4, i64 2)
...
contb2:                                           ; preds = %condb2, %contb1
  %46 = call i1 @get_creg_bit(ptr %4, i64 3)
...
contb3:                                           ; preds = %condb3, %contb2
  %47 = call i1 @get_creg_bit(ptr %4, i64 4)
...
contb4:                                           ; preds = %condb4, %contb3
  %48 = call i1 @get_creg_bit(ptr %4, i64 5)
...
contb5:                                           ; preds = %condb5, %contb4
  %49 = call i1 @get_creg_bit(ptr %3, i64 0)
...
contb6:                                           ; preds = %condb6, %contb5
  ...
  call void @__quantum__rt__int_record_output(i64 %50, ptr @0)
  %51 = call i64 @get_int_from_creg(ptr %1)
  call void @__quantum__rt__int_record_output(i64 %51, ptr @1)
  %52 = call i64 @get_int_from_creg(ptr %2)
  call void @__quantum__rt__int_record_output(i64 %52, ptr @2)
  %53 = call i64 @get_int_from_creg(ptr %3)
  call void @__quantum__rt__int_record_output(i64 %53, ptr @3)
  %54 = call i64 @get_int_from_creg(ptr %4)
  call void @__quantum__rt__int_record_output(i64 %54, ptr @4)
  ret void
}
