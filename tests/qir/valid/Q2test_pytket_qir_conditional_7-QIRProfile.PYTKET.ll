...
entry:
  ...
  %9 = icmp eq i64 3, %8
  call void @set_creg_bit(ptr %1, i64 3, i1 %9)
  %10 = call i64 @get_int_from_creg(ptr %0)
  %11 = icmp eq i64 4, %10
  call void @set_creg_bit(ptr %1, i64 4, i1 %11)
  %12 = call i64 @get_int_from_creg(ptr %0)
  %13 = icmp eq i64 4, %12
  call void @set_creg_bit(ptr %1, i64 5, i1 %13)
  %14 = call i1 @get_creg_bit(ptr %1, i64 0)
...
contb0:                                           ; preds = %condb0, %entry
  %15 = call i1 @get_creg_bit(ptr %1, i64 1)
...
contb1:                                           ; preds = %condb1, %contb0
  %16 = call i1 @get_creg_bit(ptr %1, i64 2)
...
contb2:                                           ; preds = %condb2, %contb1
  %17 = call i1 @get_creg_bit(ptr %1, i64 3)
...
contb3:                                           ; preds = %condb3, %contb2
  %18 = call i1 @get_creg_bit(ptr %1, i64 4)
...
contb4:                                           ; preds = %condb4, %contb3
  %19 = call i1 @get_creg_bit(ptr %1, i64 5)
...
contb5:                                           ; preds = %condb5, %contb4
  ...
  call void @__quantum__rt__int_record_output(i64 %20, ptr @0)
  %21 = call i64 @get_int_from_creg(ptr %1)
  call void @__quantum__rt__int_record_output(i64 %21, ptr @1)
  ret void
}
