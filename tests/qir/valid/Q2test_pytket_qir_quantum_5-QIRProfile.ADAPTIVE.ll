...
entry:
  ...
  call void @__quantum__qis__rxxyyzz__body(double 0x3FF921FB54442D18, double 0x3FF41B2F769CF0E0, double 0x3FEE28C731EB6950, ptr null, ptr inttoptr (i64 1 to ptr))
  call void @__quantum__qis__rxxyyzz__body(double 0x4012D97C7F3321D2, double 0x401197C987C952C4, double 0x40105616905F83B6, ptr inttoptr (i64 2 to ptr), ptr inttoptr (i64 1 to ptr))
...
declare void @__quantum__qis__rxxyyzz__body(double, double, double, ptr, ptr)
